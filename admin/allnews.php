...
<body>
    ...
    <tbody>
<?php while($xeberler=mysqli_fetch_assoc($query)) {?>
      <tr class="info">
        <td><?php echo $xeberler["id"]; ?></td>
        <td><?php echo $xeberler["title"]; ?></td>
        <td><?php echo $xeberler["imagePath"]; ?></td>
        <td><a href="update.php?id=<?php echo $xeberler["id"]?>">Edit</a></td>
        <td><a href="delete.php?name=<?php echo $xeberler["id"]?>">Delete</a></td>
      </tr>
			<?php } ?>
